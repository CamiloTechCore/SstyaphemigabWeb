...
4. Configurar `VITE_HERO_VIMEO_URL` con el enlace real y reconstruir. Se admiten enlaces Vimeo normales, player y enlaces no listados con hash. Permitir el dominio del sitio en la configuración de inserción de Vimeo. Temporalmente, si la variable no existe se usa el [video de ejemplo del SDK oficial de Vimeo](https://github.com/vimeo/player.js/): `https://player.vimeo.com/video/76979871?h=8272103f6e`. No representa material de EMIGAB. Una variable explícitamente vacía muestra una tarjeta de marca dentro del teléfono.
