...
4. El teléfono reproduce por defecto `APH_Video1`: `https://player.vimeo.com/video/1228365227`, con reproducción automática sin sonido y en bucle. Para reemplazarlo, configurar `VITE_HERO_VIMEO_URL` y reconstruir. Se admiten enlaces Vimeo normales, player y enlaces no listados con hash. Permitir el dominio del sitio en la configuración de inserción de Vimeo. Una variable explícitamente vacía muestra una tarjeta de marca dentro del teléfono.
