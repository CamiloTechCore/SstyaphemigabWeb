...
function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.94 }}
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-green text-white shadow-lg animate-pulse-soft md:bottom-6 md:right-6"
    >
      <FaWhatsapp size={28} />
    </motion.a>
  )
